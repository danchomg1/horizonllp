 ...
 * Проверочный QR.
 *
 * Надпись «Проверить сертификат» напечатана на бланке в правом верхнем углу
 * (снизу 540–567), QR встаёт под ней по центру. Отступ сверху — ровно те
 * четыре пустых модуля, которых требует стандарт: ниже и по бокам поле
 * бланка и так белое.
 */
export const QR = {
  /** Центр по горизонтали: середина надписи на всех трёх бланках. */
  centerX: 689,
