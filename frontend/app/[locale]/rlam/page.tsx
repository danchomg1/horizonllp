...
const content = {
  ...
  kz: {
    heroTitle: "Авария орнындағы жою жетекшісі (АЖБ)",
    heroSubtitle: "Оқиға орнында авариялық ден қоюды басқаратын мамандарды практикалық дайындау курсы",
    intro: [
      "Авария — бұл әрқашан бейберекеттік, белгісіздік, уақыт тапшылығы және орасан қауіп. Алғашқы минуттарда орындағы жетекші қалай әрекет ететініне адам өмірі мен салдар ауқымы байланысты.",
      "Авария орнындағы жою жетекшісі (АЖБ) курсы мамандарды авариялық жағдайларды басқаруға дайындау үшін үздік халықаралық тәжірибелер (UK Fire & Rescue, Incident Command System, OPITO) негізінде әзірленген.",
      "Бұл қалай істеу керек деген жай дәрістер емес: қатысушылар шынайы авария сценарийлеріне енетін, қысым астында күрделі шешім қабылдап, нәтижеге жауап беретін қарқынды тренинг.",
    ],
    audTitle: "Курс кімге арналған",
    audNote: "Әсіресе мұнай-газ, мұнай-химия, энергетика және тау-кен салаларының кәсіпорындары үшін өзекті:",
    aud: [
      { img: "icon-shift.png", text: "Кезекші ауысым жетекшілері (КАЖ/АЖБ)" },
      { img: "icon-chief.png", text: "Цех бастықтары" },
      { img: "icon-operator.png", text: "Қондырғы операторлары" },
      { img: "icon-engineer.png", text: "Өндіру жөніндегі инженерлер" },
      { img: "icon-manager.png", text: "Өндірістік учаске жетекшілері" },
      { img: "icon-hse.png", text: "ӨҚ, ЕҚ және экология мамандары" },
      { img: "icon-rescue.png", text: "Авариялық-құтқару құралымдарының қызметкерлері" },
    ],
    learnTitle: "Курс неге үйретеді",
    learnNote: "Оқу барысында қатысушылар мына бағыттар бойынша әрекет алгоритмдерін игереді:",
    learn: [
      { img: "icon-awareness.png", title: "Жағдаяттық хабардарлық", desc: "Жағдайды жылдам бағалау, сын-тағдырлы факторларды тану." },
      { img: "icon-decision.png", title: "Қысым астында шешім қабылдау", desc: "Күйзеліс жағдайында құрылымдалған алгоритмдерді (мысалы, FOR-DEC, DECIDE) қолдану." },
      { img: "icon-fcp.png", title: "Қауіпсіздік аралын ұйымдастыру (FCP)", desc: "Қауіпсіз орын таңдау, басқару постын (Forward Command Post) орналастыру." },
      { img: "icon-resources.png", title: "Ресурстарды басқару", desc: "Басымдықтарды белгілеу, міндет қою, орындалуын бақылау." },
      { img: "icon-escalation.png", title: "Ұлғаюды бақылау және оқшаулау", desc: "Аварияның дамуына жол бермеу шараларын қабылдау, сын-тағдырлы аймақтарды қорғау." },
      { img: "icon-communication.png", title: "Коммуникация және штабқа баяндау", desc: "Нақты, құрылымдалған ақпаратты жеткізу (SITREP, METHANE)." },
      { img: "icon-team.png", title: "Командалық жұмыс және көшбасшылық", desc: "Дүрбелеңмен жұмыс, орында тиімді ден қою командасын құру." },
      { img: "icon-handover.png", title: "Өкілеттікті беру", desc: "Келген кәсіби құтқарушыларға басқаруды дұрыс әрі толық тапсыру." },
    ],
    formatTitle: "Оқыту форматы",
    formatDur: "Ұзақтығы: 3 күн",
    day12: {
      img: "icon-theory.png", title: "1-2 күн — теория және үстел үстіндегі дайындық",
      items: ["Орындағы жетекшінің рөлі мен жауапкершілігі.", "Заңнама және жергілікті рәсімдер.", "Төтенше жағдайдағы адам мінез-құлқының психологиясы.", "Байланыс пен өзара іс-қимылды ұйымдастыру (SITREP баяндамасы).", "Орында қауіптерді бағалау құралдары (Dynamic Risk Assessment)."],
      note: "3D-макеттер мен жоспарларда кірістірулерді пысықтау, өз бетінше шешім қабылдау және жағдайды басқару.",
    },
    day3: {
      img: "icon-practice.png", title: "3-күн — практикалық сценарийлер",
      desc: "Нақты жабдықты, отты, түтіндеуді және қауіпті заттардың ағуын имитациялауды пайдалана отырып полигондағы практика.",
      scenTitle: "Сценарийлер қамтиды:",
      scen: ["Технологиялық қондырғыдағы өрт;", "Зардап шеккендері бар улы газдың ағуы;", "Химиялық қауіпті заттың төгілуі."],
      taskTitle: "Сценарийлердегі командир міндеттері:",
      tasks: ["жағдайды бағалау;", "көмек сұрау және эвакуацияны ұйымдастыру;", "командаға міндет қою және басқаруды тапсыру."],
    },
    methodTitle: "Horizon-ның бірегей әдістемесі",
    methodDesc: "Курс Training Under Stress (күйзеліс жағдайында жаттығу) тәсілін қолданады — бұл сын-тағдырлы жағдайларда әрекет автоматизмін қалыптастырудың аса маңызды шарты.",
    methodSimTitle: "Имитацияланады:",
    methodSim: ["ақпараттың тапшылығы мен қарама-қайшылығы;", "уақыт факторы және жағдайдың кенет өзгеруі (ұлғаю);", "команда мүшелерінің қателіктері немесе дүрбелеңі;", "шу, нашар көріну және басқа алаңдататын факторлар."],
    methodNote: "Бұл нақты ауыртпалықты сезінуге және онымен күресуді үйренуге мүмкіндік береді.",
    assessTitle: "Құзыретті бағалау",
    assessDesc: "Курс қорытындысы бойынша білім мен дағдыны кешенді бағалау жүргізіледі.",
    assessTheoTitle: "Теориялық тест:",
    assessTheo: ["ICS негіздері;", "қауіптерді бағалау;", "коммуникациялық хаттамалар;", "эвакуация рәсімдерін түсіну."],
    assessPractTitle: "Практикалық емтихан:",
    assessPract: ["модельденген төтенше жағдайда команданы өз бетінше басқару;", "күйзеліс астында дұрыс шешім қабылдау қабілеті;", "ақпарат пен басқаруды дұрыс тапсыру."],
    assessNote: "Әрбір қатысушы жеке кері байланыс пен ұсыныстар алады.",
    partTitle: "Қатысушылар не алады",
    partSkills: "Халықаралық деңгейде танылатын дағдылар:",
    part: ["нақты төтенше жағдайдағы әрекеттеріне сенімділік;", "авариялық бригада жетекшісі (АЖБ) мәртебесі;", "оқуды сәтті аяқтағаны туралы сертификат."],
    compTitle: "Компания үшін нәтиже",
    compLead: "Оқиға орнындағы дайын командир, ол:",
    comp: ["жағдайды жылдам бақылауға алып, ұлғаюға (салдар ауқымының өсуіне) жол бермейді;", "персонал арасындағы жарақаттану қаупін азайтады;", "қаржылық және экологиялық шығынды, сондай-ақ репутациялық зиянды барынша азайтады."],
    compNote: "Бұл кәсіпорын қауіпсіздігіне және авария кезіндегі материалдық салдарды азайтуға тікелей инвестиция.",
    cta: "Өтінім қалдыру",
  },
};
