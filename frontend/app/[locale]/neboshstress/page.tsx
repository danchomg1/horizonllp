...
const content = {
  ...
  kz: {
    heroRight: "Басшылар мен мамандарға жұмыс ортасындағы күйзеліс көздерін анықтау және жою құралдарын беретін курс: абстрактілі мәселені басқарылатын процеске айналдырады.",
    pillars: ["Күйзеліс көздерін анықтау", "Оның салдарын азайту", "Салауатты және ынталандыратын жұмыс ортасын құру"],
    pillarsImgs: ["icon-stress-source.png", "icon-stress-reduce.png", "icon-stress-env.png"],
    valueTitle: "Бұл курс не үшін пайдалы?",
    valueDesc1: "Курстың басты құндылығы — ол жүйелі тәсіл береді.",
    valueDesc2: "Аз күйзеліңіз деген абстрактілі кеңестің орнына сіз құрал (Risk Assessment) аласыз: ол жұмыс дизайнында (жүктемеде, бақылауда немесе қатынастарда) дәл қай жерде ақау бар екенін анықтап, оны кез келген басқа өндірістік қауіп сияқты жоюға мүмкіндік береді.",
    audTitle: "Кімге арналған",
    audIntro: "Ол тек еңбекті қорғау мамандарына емес, адамдарды басқаратындардың бәріне арналған:",
    aud: ["Желілік басшылар мен менеджерлер.", "HR мамандары.", "Еңбекті қорғау мамандары (HSE managers).", "Корпоративтік денсаулық мамандары (Occupational health)."],
    progTitle: "Оқу бағдарламасы",
    progIntro: "Курс ықшам, әдетте 1 күнге созылады (шамамен 7 сағат оқу) және үш негізгі модульден тұрады:",
    modules: [
      {
        img: "icon-module-1.png", num: "1-модуль:", title: "Негізгі қағидаттар (Key Principles)",
        items: ["Күйзеліс, қысым және психикалық ауру ұғымдарының айырмашылығы.", "Статистика: күйзелістің таралуы және бизнестің қаржылық шығыны.", "Қызметкерлердегі күйзеліс белгілері.", "Күйзелісті басқару бойынша жұмыс берушінің құқықтық міндеттері."],
      },
      {
        img: "icon-module-2.png", num: "2-модуль:", title: "Қауіптерді анықтау (Identification of Risk)",
        intro: "Бұл курстың өзегі. Мұнда HSE Management Standards зерттеледі — басқарылмаса күйзеліске әкелетін жұмыстың 6 негізгі саласы:",
        standards: [
          { key: "Demands (Талаптар):", val: "Жұмыс көлемі, мерзімдер, еңбек жағдайлары." },
          { key: "Control (Бақылау):", val: "Қызметкер жұмыстың орындалуына қаншалықты ықпал ете алады." },
          { key: "Support (Қолдау):", val: "Басшылық пен әріптестер тарапынан ынталандыру және ресурстар." },
          { key: "Relationships (Қатынастар):", val: "Қақтығыстар, буллинг, харассмент." },
          { key: "Role (Рөл):", val: "Қызметкер құрылымдағы міндеттерін түсінеді ме." },
          { key: "Change (Өзгерістер):", val: "Ұйым өзгерістер туралы қалай хабарлайды." },
        ],
      },
      {
        img: "icon-module-3.png", num: "3-модуль:", title: "Шараларды енгізу (Implementing Interventions)",
        items: ["Күйзеліс қауіптерін бағалауға HSE тәсілін қалай қолдану керек.", "Күйзеліс деңгейін азайту үшін нақты шараларды әзірлеу.", "Жұмыс ортасын үздіксіз жақсарту жолдары."],
      },
    ],
    formatTitle: "Курс форматы",
    dur: "1 күн оқу",
    test: "+ Жұмыс сценарийі бойынша тест",
    cta: "Өтінім қалдыру",
  },
};
