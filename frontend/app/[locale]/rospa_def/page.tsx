...
const content = {
  ...
  kz: {
    heroSubtitle: "RoSPA Level 2 бағдарламасы",
    heroRight: "Жол оқиғалары өнеркәсіп және энергетика салаларындағы өлім себептерінің бірі болып қала береді. RoSPA Level 2 бағдарламасы қауіпсіздікке кешенді тәсіл ұсынады.",
    intro: "Бұл курс автокөлікті басқарудың негізгі техникалық дағдыларынан асып түседі. Біз жүргізуші мінез-құлқының психологиясын зерттейміз, жасырын қауіптерді тануға үйретеміз және көлік жүргізуге оң көзқарас қалыптастырамыз. Бағдарлама жүргізушілерге кез келген ортада — қала жолдарынан бастап экстремалды жол талғамайтын жағдайлар мен күрделі ауа райына дейін — көлікті сенімді әрі қауіпсіз басқаруға мүмкіндік береді.",
    goalsTitle: "Бағдарлама мақсаттары",
    goals: [
      { img: "icon-goal-min.png", title: "Қауіптерді азайту:", desc: "Авария ықтималдығын төмендету үшін қорғаныштық көлік жүргізудің тұрақты дағдыларын дамыту." },
      { img: "icon-goal-prevent.png", title: "Жол оқиғаларының алдын алу:", desc: "Соқтығысудан белсенді түрде жалтару әдістерін терең үйрету." },
      { img: "icon-goal-aware.png", title: "Жағдаяттық хабардарлық:", desc: "Күтпеген кедергілер мен жол жағдайының өзгеруіне жауап беру жылдамдығын арттыру." },
    ],
    audTitle: "Мақсатты аудитория",
    aud: [
      "Барлық санаттағы кәсіби жүргізушілер.",
      "Энергетика және өнеркәсіп саласы компанияларының корпоративтік жүргізушілері.",
      "Автокөлікті басқару кезінде барынша жоғары қауіпсіздік деңгейіне ұмтылатын жеке тұлғалар.",
    ],
    topicsTitle: "Курстың негізгі тақырыптары:",
    topics: [
      { img: "icon-topic-base.png", text: "Қорғаныштық көлік жүргізу негіздері." },
      { img: "icon-topic-weather.png", text: "Ауа райы мен жол жағдайының өзгеруіне жауап беру." },
      { img: "icon-topic-stress.png", text: "Күйзелісті басқару техникалары." },
      { img: "icon-topic-decision.png", text: "Рөл артында шешім қабылдаудың психологиялық аспектілері." },
    ],
    formatTitle: "Бағдарлама форматы",
    format: [
      { img: "icon-format-time.png", title: "Ұзақтығы:", desc: "1–2 күн (қатысушылардың бастапқы дайындық деңгейіне қарай өзгереді)." },
      { img: "icon-format-methods.png", title: "Оқыту әдістері:", desc: "Теориялық дәрістер және нақты жол жағдайларын бейнеталдау. Жолдағы қарқынды практикалық сабақтар." },
      { img: "icon-format-eval.png", title: "Бағалау әдістері:", desc: "Емтихандық тестілеу және сараптамалық түсініктемелермен, кейс-стади талдауымен практикалық көлік жүргізу." },
    ],
    benefitsTitle: "Бағдарламаның артықшылықтары",
    benefits: [
      { img: "icon-ben-intl.png", title: "Халықаралық сертификаттау:", desc: "Бүкіл әлемде танылатын ресми құжат беріледі." },
      { img: "icon-ben-risk.png", title: "Қауіптерді азайту:", desc: "Жол оқиғалары мен олармен байланысты жарақаттар жиілігінің айтарлықтай қысқаруы." },
      { img: "icon-ben-personal.png", title: "Жеке даму:", desc: "Рөл артындағы сенімділік пен жол жағдайын сыни қабылдау дағдыларының өсуі." },
      { img: "icon-ben-econ.png", title: "Экономикалық тиімділік:", desc: "Пайдалану ақаулары мен авариялар салдарынан компанияның тоқтап қалуы мен шығынының азаюы." },
      { img: "icon-ben-rep.png", title: "Репутациялық капитал:", desc: "Компанияның қауіпсіздіктің жоғары стандарттарына берілгендігін және қызметкерлерге қамқорлығын көрсету." },
    ],
    cta: "Өтінім қалдыру",
  },
};
