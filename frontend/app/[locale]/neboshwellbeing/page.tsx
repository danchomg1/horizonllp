...
const content = {
  ...
  kz: {
    heroSubtitle: "Жұмыстағы әл-ауқатты қамтамасыз ету бойынша NEBOSH HSE біліктілігі",
    heroRight: "Курс әл-ауқат (wellbeing) ұғымын абстрактілі идеядан менеджерлер мен HR үшін нақты құралдар жиынтығына айналдырады.",
    intro: "Бұл салауатты жұмыс атмосферасын құруға бағытталған кіріспе бір күндік біліктілік. Курстың негізінде адам жағдайына әсер ететін 6 негізгі саланы қамтитын NEBOSH Әл-ауқат ағашы (NEBOSH Wellbeing Tree) моделі жатыр.",
    audTitle: "Бұл курс кімге арналған?",
    aud: [
      { img: "icon-aud-hr.png", title: "HR мамандары:", desc: "Персоналды ұстау және шаршауды азайту стратегияларын енгізу үшін." },
      { img: "icon-aud-hse.png", title: "Еңбекті қорғау мамандары (HSE):", desc: "Сараптаманы физикалық қауіпсіздік шегінен тыс кеңейту үшін." },
      { img: "icon-aud-managers.png", title: "Желілік басшылар мен менеджерлер:", desc: "Өз командаларын қолдауды үйрену үшін." },
      { img: "icon-aud-leaders.png", title: "Команда көшбасшылары:", desc: "Өнімді және қолдау көрсететін орта құрғысы келетіндердің бәрі." },
    ],
    whyTitle: "Бұл не үшін керек",
    whyIntro: "Басты мақсат — қызметкерлердің көңіл-күйі мен бизнес табысы арасындағы тікелей байланысты көрсету. Салауатты адамдар — салауатты бизнес.",
    why: [
      { img: "icon-ben-loss.png", title: "Шығынды азайту:", desc: "Еңбекке жарамсыздық, кадр ағыны және жарақаттану жағдайларының азаюы." },
      { img: "icon-ben-eff.png", title: "Тиімділіктің өсуі:", desc: "Тартылым, көңіл-күй және еңбек өнімділігінің артуы." },
      { img: "icon-ben-sol.png", title: "Дайын шешімдер:", desc: "Теорияның орнына тиімділігі дәлелденген практикалық бастамалар жиынтығын аласыз." },
      { img: "icon-ben-culture.png", title: "Мәдениет:", desc: "Қызметкерлер қолдау сезінетін ортаны қалыптастыру." },
    ],
    treeTitle: 'Бағдарлама: "Әл-ауқат ағашы" моделі',
    treeIntro: "Курс әл-ауқаттың 6 тармағының төңірегінде құрылады. Олардың әрқайсысы жұмысқа қалай әсер ететінін және оларды қалай дамытуға болатынын білесіз:",
    tree: [
      { img: "icon-tree-interaction.png", title: "Өзара іс-қимыл (Interaction)", desc: "Ұжым ішіндегі қарым-қатынас пен әлеуметтік байланыстардың денсаулыққа әсері." },
      { img: "icon-tree-exercise.png", title: "Қозғалыс (Exercise/Movement)", desc: "Күйзеліс пен ауруларды болдырмаудағы физикалық белсенділіктің рөлі." },
      { img: "icon-tree-mindfulness.png", title: "Зейінділік (Mindfulness)", desc: "Назарды және психикалық денсаулықты басқару." },
      { img: "icon-tree-nutrition.png", title: "Тамақтану (Nutrition)", desc: "Дұрыс тамақтанудың энергия деңгейі мен зейінге әсері." },
      { img: "icon-tree-kindness.png", title: "Мейірімділік (Kindness)", desc: "Қолдау мен құрмет мәдениеті бизнеске неге тиімді." },
      { img: "icon-tree-learning.png", title: "Оқу (Learning)", desc: "Дамудың мотивация және өмірге қанағаттану факторы ретіндегі рөлі." },
    ],
    formatTitle: "Оқыту және емтихан форматы",
    durLabel: "Ұзақтығы:",
    durDesc: "1 күн (шамамен 7 сағат оқу).",
    evalTitle: "Бағалау (емтихансыз):",
    evalIntro: "Тестің орнына сіз оқу процесінде компанияңызға нақты пайда келтіретін практикалық жұмысты орындайсыз (Unit WEL1):",
    eval: [
      { img: "icon-eval-plan.png", title: "Талдау:", desc: "Әл-ауқат ағашының 6 бағытының әрқайсысы бойынша компанияңыздың күшті және әлсіз жақтарын бағалайсыз." },
      { img: "icon-eval-plan.png", title: "Іс-қимыл жоспары:", desc: "Жағдайды жақсартудың нақты шараларын және олардың тиімділігін бағалау тәсілдерін ұсынып, Араласу жоспарын (Intervention Plan) әзірлейсіз." },
    ],
    cta: "Өтінім қалдыру",
  },
};
