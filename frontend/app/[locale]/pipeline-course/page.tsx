...
const content = {
  ...
  kz: {
    heroTitle: "Құбырлардағы аварияларды жою",
    heroSubtitle: "Авариялық-құтқару қызметтерін практикалық дайындау",
    descTitle: "Құбырлардағы аварияларды оқшаулау және жою бойынша\nқарқынды практикалық курс",
    desc: [
      "Құбырлардағы авариялар орасан қауіп төндіреді: қауіпті заттардың ағуы, өрт, экологиялық зиян және өндірістің тоқтауы. Алғаш келген бөлімшелердің әрекет жылдамдығы мен дұрыстығына адам өмірі және салдар ауқымы байланысты.",
      "Курс қатысушыларды қысымдағы құбырлардың шынайы тренажер-симуляторларын пайдалана отырып, нақты авария жағдайындағы әрекеттерге дайындайды.",
      "Бағдарлама команда ішіндегі үйлестіруді пысықтауды, оқшаулау мен жөндеудің дұрыс әдістерін таңдауды, сондай-ақ мамандандырылған жабдықты қолдануды қамтиды.",
    ],
    audTitle: "Курс кімге арналған",
    aud: [
      { img: "icon-rescue.png", text: "Кәсіпорындардың авариялық-құтқару қызметтері" },
      { img: "icon-fire.png", text: "Өрт және газдан құтқару бөлімшелері" },
      { img: "icon-repair.png", text: "Авариялық-жөндеу бригадаларының жұмысшылары" },
      { img: "icon-operator.png", text: "Технологиялық қондырғы операторлары" },
      { img: "icon-hse.png", text: "Өнеркәсіптік қауіпсіздік және ЕҚ мамандары" },
      { img: "icon-staff.png", text: "Штаттан тыс авариялық-құтқару құралымдарының қызметкерлері" },
    ],
    objTitle: "Оқыту мақсаттары",
    objLead: "Курс барысында қатысушылар практикалық дағдыларды игереді:",
    obj: [
      "Жағдайды бағалау және авария орнын барлау.",
      "Тиісті жеке қорғаныс құралдарын таңдау және қолдану.",
      "Құбырдың авариялық учаскесін оқшаулау.",
      "Қысым астында бандаж, қамыт және тығындар орнату.",
      "Орындалған жөндеу жұмыстарының сапасын бақылау.",
    ],
    formatTitle: "Оқыту форматы",
    formatInfo: [
      { label: "Ұзақтығы:", val: "2-3 күн (дайындық деңгейіне қарай)." },
      { label: "Формат:", val: "30% теория / 70% полигондағы практика." },
      { label: "Бағалау:", val: "Сценарийлер бойынша практикалық емтихан." },
    ],
    formatCards: [
      { img: "icon-theory.png", text: "Интерактивті теория" },
      { img: "icon-demo.png", text: "Жабдықты көрсету" },
      { img: "icon-practice.png", text: "Тренажерлардағы практика" },
      { img: "icon-exam.png", text: "Қорытынды жаттығулар" },
    ],
    topicsTitle: "Курстың негізгі тақырыптары",
    topics: [
      { img: "icon-danger.png", title: "Құбырлардағы авария кезіндегі қауіптер", items: ["Қауіпті заттардың қасиеттері.", "Газ бен сұйықтық ағу процестерінің физикасы.", "Газдану және өрт аймақтары.", "Персонал үшін қауіп факторлары."] },
      { img: "icon-ppe.png", title: "Жеке қорғаныс құралдары және ТДА", items: ["Тыныс алу мүшелері (ТДА) мен теріні қорғау құралдарын таңдау.", "Кию және тексеру қағидалары.", "Аппаратта жұмыс істеу уақытын бақылау."] },
      { img: "icon-equip.png", title: "Мамандандырылған жабдық", intro: "Ағуды оқшаулауға арналған жабдық:", items: ["пневматикалық бандаждар мен жапсырмалар;", "механикалық қамыттар мен қысқыштар;", "герметиктеу пасталары мен таспалары.", "Ұшқын шығармайтын құрал."] },
    ],
    scenTitle: "Практикалық сценарийлер",
    scenLead: "Курстың екінші күні қатысушылар шынайы жаттығу сценарийлерін орындайды:",
    scenarios: [
      { img: "icon-gas.png", title: "Жер үсті құбырындағы газдың ағуы", desc: "— пневматикалық бандажбен оқшаулау;\n— жұмыс аймағын ұйымдастыру." },
      { img: "icon-oil.png", title: "Мұнай құбырының жарылуы және өнімнің төгілуі", desc: "— бандаж орнату;\n— сорбенттерді қолдану және өнімді жинау." },
      { img: "icon-flange.png", title: "Қысым астындағы фланец қосылысындағы ағу", desc: "— арнайы қаптама орнату;\n— қысым мен герметикалықты бақылау." },
    ],
    skillsTitle: "Қатысушылар қандай дағды алады",
    skillsLead: "Курс қорытындысы бойынша қатысушылар:",
    skills: ["құбырлардағы авария кезінде жағдайды жылдам бағалай алады;", "оқшаулау әдістерін таңдай алады;", "ТДА-да қауіпсіз жұмыс істей алады;", "командада үйлесімді әрекет ете алады."],
    resultTitle: "Кәсіпорын үшін нәтиже",
    resultLead: "Курстан өткеннен кейін кәсіпорын персоналы:",
    result: ["аварияға ден қою уақытын қысқарта алады;", "ағудан келетін зиянды азайта алады;", "жөндеу жұмыстарын жүргізу қауіпсіздігін арттыра алады."],
    cta: "Өтінім қалдыру",
  },
};
