...
const content = {
  ...
  kz: {
    heroSubtitle: "Стандарттар бойынша менеджмент жүйелерін әзірлеу және енгізу",
    heroTitle: "ISO 9001, 14001 және 45001",
    heroRight: "Құжаттама базасын интеграциялау және персоналдың құзыретін арттыру арқылы басқару процестерінің тиімділігін қамтамасыз етеміз. Диагностика, әзірлеу, сүйемелдеу.",
    integTitle: "Стандарттарды нақты бизнес-процестерге\nинтеграциялау",
    integDesc: "Тиімді менеджмент жүйесі — реттеуші құжаттама мен персонал біліктілігі арасындағы теңгерім. Horizon тәсілі стандарттарға ресми қарауды жоққа шығарады. Біз ұйымның барлық деңгейінде жұмыс істейтін басқару архитектурасын құрамыз.",
    prioritiesTitle: "Біздің басымдықтарымыз:",
    priorities: [
      { img: "icon-competence.png", title: "Процесс иелерінің құзыреті:", desc: "Біз жай нұсқаулық бермейміз, нәтижеге жауапты қызметкерлердің әдістеме мен мақсаттарды түсінуін қамтамасыз етеміз." },
      { img: "icon-changes.png", title: "Өзгерістерді басқару:", desc: "Енгізілетін тетіктер сапа, экологиялық қауіпсіздік және еңбекті қорғау көрсеткіштерін нақты жақсартуға бағытталған." },
      { img: "icon-result.png", title: "Нәтижелілік:", desc: "Жүйе процестердің өмірлік циклін ескере отырып әзірленеді, бұл икемділік пен жедел ден қоюды қамтамасыз етеді." },
    ],
    dirTitle: "Енгізу және оңтайландыру бағыттары",
    standards: [
      { title: "ISO 9001 (Сапа менеджменті жүйелері):", desc: "Операциялық процестерді оңтайландыру және тұтынушылардың қанағаттануын арттыру." },
      { title: "ISO 14001 (Экологиялық менеджмент жүйелері):", desc: "Экологиялық аспектілерді жүйелі басқару және қауіптерді азайту." },
      { title: "ISO 45001 (Еңбек қауіпсіздігі және денсаулықты сақтау):", desc: "Қауіпсіз еңбек жағдайын қамтамасыз ету және кәсіптік қауіптерді алдын ала басқару." },
    ],
    dirNote: "Біз бизнес міндеттеріне қарай біріктірілген менеджмент жүйелерін (БМЖ) енгізу бойынша да, жекелеген стандарттар бойынша да жобаларды жүзеге асырамыз.",
    stepsTitle: "Horizon ішкі стандартына сәйкес жұмыс кезеңдері",
    steps: [
      { label: "1. Проблематиканы анықтау:", desc: "Ағымдағы сәйкессіздіктерді айқындау және енгізудің стратегиялық мақсаттарын қою." },
      { label: "2. Диагностикалық талдау:", desc: "Қолданыстағы басқару процестерін аудиттеу және олардың кемелдігін бағалау." },
      { label: "3. Жүйелік шешімдерді әзірлеу:", desc: "Сала ерекшелігін ескере отырып менеджмент жүйесін жобалау және құжаттау." },
      { label: "4. Енгізуді сүйемелдеу:", desc: "Процестерді іске қосу және стандарттарды операциялық қызметке интеграциялау кезінде әдістемелік қолдау." },
      { label: "5. Нәтижелілікті бағалау:", desc: "Жүйе жұмысының тиімділігін талдау және түзету әрекеттері." },
    ],
    expertsTitle: "Ішкі сарапшылар институтын қалыптастыру",
    expertsDesc: "Horizon-ның негізгі міндеті — жоба аяқталғаннан кейін тапсырыс берушінің дербестігін қамтамасыз ету. Енгізу аясында біз компанияңыздың ішкі сарапшылар пулын қалыптастырамыз.",
    experts: [
      { img: "icon-training.png", title: "Персоналды дайындау:", desc: "Ішкі аудиторлар мен процесс иелерін бақылау және бағалау әдістеріне оқыту." },
      { img: "icon-audit.png", title: "Аудитті стандарттау:", desc: "Міндеттеріңізге бейімделген тиімділікті бағалаудың ішкі өлшемдерін әзірлеу." },
      { img: "icon-certification.png", title: "Сертификаттауға дайындық:", desc: "Компанияның сыртқы аудит талаптарына сәйкестікті өз бетінше ұстап тұру және процестерді үздіксіз жетілдіру қабілетін қамтамасыз ету." },
    ],
    resultLabel: "Нәтиже:",
    resultDesc: "Тапсырыс беруші жұмыс істейтін жүйені және оны ұстап тұру мен дамытуға құзыретті команданы алады.",
    cta: "Өтінім қалдыру",
