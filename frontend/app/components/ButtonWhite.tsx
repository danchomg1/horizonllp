...
export default function ButtonWhite({ children, className = '', onClick, type, noModal, ...props }: ButtonProps) {
  ...
  return (
    <button 
      ...
      className={`
        ...
        bg-white text-[#0B0073] font-semibold text-[16px]
        ...
        /* Нейтральная тень для светлой кнопки */
    ...
    >
      ...
      {/* relative z-10 нужно, чтобы текст был ПОВЕРХ черного фона.
          group-hover:text-white делает текст белым при наведении */}
